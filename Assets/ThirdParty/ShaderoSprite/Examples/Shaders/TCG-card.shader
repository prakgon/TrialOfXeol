...
float4 Mask2RGBA_1 = lerp(_ColorHSV_1,_Generate_Fire_1, lerp(NewTex_3.r, 1 - NewTex_3.r ,0.017));
...
float4 _Displacement_Plus_2 = DisplacementPlusUV(ZoomUV_1,_SourceNewTex_2,TurnAlphaToBlack_1,NewTex_3,0,-0.869,0.331);
_Displacement_Plus_2.r *= _RGBA_Mul_Fade_1;
float4 OperationBlend_5 = OperationBlend(SourceRGBA_3, _Displacement_Plus_2, 1); 
float4 OperationBlend_1 = OperationBlend(Mask2RGBA_1, OperationBlend_5, 1); 
...
float4 OperationBlend_3 = OperationBlend(SourceRGBA_2, SourceRGBA_4, 1); 
float4 OperationBlend_4 = OperationBlend(TurnBlackToAlpha_1, OperationBlend_3, 1); 
float4 _Burn_1 = BurnFX(OperationBlend_4,i.texcoord,_Burn_Value_1,_Burn_Speed_1,2);
float4 OperationBlend_2 = OperationBlend(Mask2RGBA_2, _Burn_1, 1); 
float4 _Destroyer_1 = DestroyerFX(OperationBlend_2,i.texcoord,_Destroyer_Value_1,_Destroyer_Speed_1,0.915);
